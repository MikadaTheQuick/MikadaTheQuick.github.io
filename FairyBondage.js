...
// @version      2024-12-29
// @description  Magical Bondage for Magical Beings
// @author       Mikada the Quick
// @match        https://*.bondageprojects.elementfx.com/R*/*
// @match        https://*.bondage-europe.com/R*/*
// @match        https://*.bondageprojects.com/R*/*
// @match        http://localhost:*/*
// @icon         https://i.imgur.com/FzTMSuC.png
// @grant        none
// @run-at document-end
// ==/UserScript==
...
async function LoadFairyBondage() {

    //#BoilerplateSetup
    //General Addon Registration and Initialisation
    "use strict";
    // did the sdk load?
    ...
    // Are we running Bondage Club?
    if (typeof ChatRoomCharacter === "undefined") {
        console.warn("Bondage Club not detected. Skipping FB initialization.");
        return;
    }
    //#End BoilerplateSetup

    //#InitHooksAndVariables
    //Initialize hooks and define some variables
    ...
    console.info("FairyBondage Loaded.");
    //#End InitHooksAndVariables

}

function GetBindingCrafts() {
    ...
    for (var i = 0; i<crafts.length; i++){
        if (!(crafts[i].Craft?.Description == null)){
            let keylist = [];
            for (var keyword in tokens){
                const regex = new RegExp(`\\b(${tokens[keyword].join('|')})\\b`, 'g'); //generate Regex to search for tokens
                if(crafts[i].Craft?.Description?.search(regex)!=-1) { //search using Regex
    ...
    //return list of Wing Binding Items
    return(bindingCrafts);
}
